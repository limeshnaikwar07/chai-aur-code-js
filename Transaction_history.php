...
<body>
    ...
    <div class="sidebar">
        ...
        <a class="account mt-2" href="Transaction_history.php"><i class="bi bi-clock-history me-2"></i> Transaction History</a>
        <hr>
        <!-- REPORT -->
        <a href="report.php"> <i class="bi bi-file-earmark-text me-2 "></i>Report</a>
    ...
    <div class="main">
        ...
        <!-- TOP BAR WITH INTEGRATED PROFILE HOVER DROPDOWN -->
        <div class="d-flex justify-content-end align-items-center mb-4">
            <div class="profile-wrapper">
                ...
                <!-- Hidden Card Menu (Visible on Hover) -->
                <div class="hover-card">
                    <div class="p-3">
                        <a href="profile.php" class="menu-link">
                            <i class="bi bi-person me-1"></i> My Profile
                        </a>
                        <!-- Linked to bootstrap modal popup trigger -->
