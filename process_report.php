...
<head>
    ...
    <style>
        ...
        .border-blue {
            ...
            /* Adjust hex code for your preferred shade of blue */
        }

        /* Optional: Keeps it blue when the user clicks/focuses on it */
        .border-blue:focus {
...
<body>
    ...
    <div class="main">
        ...
        <!-- USE THIS BUTTON TO GENERATE REPORTS BASED ON SELECTED DATE RANGES. THE INTERACTIVE TOGGLING OF DATE FIELDS ENHANCES USER EXPERIENCE, ALLOWING FOR A CLEAN INTERFACE UNTIL THE USER CHOOSES TO GENERATE A REPORT. THE STYLED BUTTON AND FORM FIELDS PROVIDE A MODERN LOOK AND FEEL, MAKING IT EASY FOR USERS TO NAVIGATE AND USE THE REPORT GENERATION FEATURE.  -->


        <!-- <div class="d-flex justify-content-end w-100">
            <div class="card p-3 mb-4 shadow-sm" style="max-width: 350px; border-radius: 12px; border: none;">
                <div class="d-flex justify-content-end">
                    <button class="btn btn-primary d-flex align-items-center gap-2  w-100" id="toggleReportFields" style="border-radius: 8px; max-width: 350px; font-weight: 500;">
            ...
            <form action="process_report.php" method="GET">
                <div class="row g-2">
                    <div class="col-md-8">
                        ...
                        <!-- Added "border-blue" class -->
                        <input type="date" class="form-control form-control-lg border-2 border-blue" name="from_date" required>
                    </div>
                    <div class="col-md-8">
                        <label class="form-label small text-muted mb-1">To Date</label>
                        <!-- Added "border-2" and "border-blue" classes -->
                        <input type="date" class="form-control form-control-lg border-2 border-blue" name="to_date" required>
                    </div>
                </div>
                <div class="d-flex justify-content-end gap-2 mt-3 w-100">
                    <button type="button" class="btn btn-secondary btn-sm" id="cancelReport">Cancel</button>
                    <button type="submit" class="btn btn-warning btn-sm px-3">Fetch Report</button>
                </div>
            </form>
        </div>
